...
function initContactSection(data) {
  ...
  data.contacts.forEach(c => {
    ...
    // Format phone number for display: 99600 33258
    const displayPhone = c.phone.slice(0, 5) + ' ' + c.phone.slice(5);
    ...
    card.innerHTML = `
      ...
      <div class="contact-info">
        ...
        <p style="font-size: 1.05rem; font-weight: 800; color: var(--primary-saffron); margin-bottom: 12px; letter-spacing: 0.5px;">
          <i class="fas fa-phone-alt" style="margin-right: 6px;"></i>${displayPhone}
        </p>
